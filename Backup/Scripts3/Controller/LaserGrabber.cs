...
{
    public GameSettings Settings; // get access to the Settings Script
    ...
    private void moveGrabbedObject()
    {
        if (laser.activeSelf)
        {
            ...
            attachedObject.transform.position = transform.position + (laser.transform.position - gameObject.transform.position) * 2;
