...
public class LocalElementData {
    ...
    public static readonly Dictionary<string, Element> m_localElementDict = new Dictionary<string, Element> {
        ...
        {  "C", new Element( "7440-44-0",        "Carbon",   6, 1.5f, new Color(144 / 255f, 144 / 255f, 144 / 255f)) },
        ...
        { "Eu", new Element( "7440-53-1",      "Europium",  63,   3f, new Color( 97 / 255f, 255 / 255f, 199 / 255f)) },
        { "Gd", new Element( "7440-54-2",    "Gadolinium",  64, 1.5f, new Color( 69 / 255f, 255 / 255f, 199 / 255f)) },
        { "Tb", new Element( "7440-27-9",       "Terbium",  65,   3f, new Color( 48 / 255f, 255 / 255f, 199 / 255f)) },
        { "Dy", new Element( "7429-91-6",    "Dysprosium",  66, 1.5f, new Color( 31 / 255f, 255 / 255f, 199 / 255f)) },
        { "Ho", new Element( "7440-60-0",       "Holmium",  67,   3f, new Color(  0 / 255f, 255 / 255f, 156 / 255f)) },
        { "Er", new Element( "7440-52-0",        "Erbium",  68, 1.5f, new Color(  0 / 255f, 230 / 255f, 117 / 255f)) },
        { "Tm", new Element( "7440-30-4",       "Thulium",  69,   3f, new Color(  0 / 255f, 212 / 255f,  82 / 255f)) },
        { "Yb", new Element( "7440-64-4",     "Ytterbium",  70, 1.5f, new Color(  0 / 255f, 191 / 255f,  56 / 255f)) },
        { "Lu", new Element( "7439-94-3",      "Lutetium",  71,   3f, new Color(  0 / 255f, 171 / 255f,  36 / 255f)) },
